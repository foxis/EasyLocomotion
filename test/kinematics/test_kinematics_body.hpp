...
void test_kinematics_body() {
    ...
    body.current_joints[0][1] = -M_PI/4;
    body.current_joints[1][1] = -M_PI/4;
    body.forward_limbs();
    ...
    memcpy(body.current_joints[0], body.target_joints[0], sizeof(real_t) * 2);
    memcpy(body.current_joints[1], body.target_joints[1], sizeof(real_t) * 2);
    body.forward_limbs();
    ...
    memset(body.current_joints[0], 0, sizeof(real_t) * 2);
    memset(body.current_joints[1], 0, sizeof(real_t) * 2);
    ...
    print_arr<real_t, 2>(body.target_joints[0], "target joints 0");

    print_vector(body.limb_pos[1], "body inv limb 1");
    print_vector(body.actual_limb_pos[1], "body inv limb actual 1");
    print_arr<real_t, 2>(body.target_joints[1], "target joints 1");
